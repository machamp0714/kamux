...
| 実装者の report の測定表と、production コメントへ書いた例示 | 同じことを言っている | **食い違っていた。突き合わせ手順が無い** |
...
**dispatch の指示が本ファイル・`task-reviewer.md`・契約のいずれかと正面から食い違ったとき、優先順位がどこにも書かれていなかった。stage5 で 4 回**（台帳 #135 / #139 / #153 / #163）。
